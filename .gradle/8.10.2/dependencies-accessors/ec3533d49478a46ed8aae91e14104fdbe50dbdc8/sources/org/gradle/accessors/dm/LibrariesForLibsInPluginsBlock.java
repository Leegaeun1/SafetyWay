...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>secretsPlugin</b> with value <b>2.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class GoogleAndroidPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>google.android.secrets</b> with plugin id <b>com.google.android.libraries.mapsplatform.secrets-gradle-plugin</b> and
         * with version reference <b>secretsPlugin</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getSecrets() { return createPlugin("google.android.secrets"); }
